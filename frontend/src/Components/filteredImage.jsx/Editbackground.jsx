...
function EditBackground() {
  ...
  // const [comparisonMode, setComparisonMode] = useState("uploaded_vs_selected"); // New state
  ...
  //     setCompareImages({
  //       itemOne: image || selectedImage,
  //       itemTwo: selectedImage,
  //     });
  //   }
  // }, [image, selectedImage, processedImage, uploadImage]);
